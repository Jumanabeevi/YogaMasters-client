...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@yogamaster-ecommerce.5x2ml.mongodb.net/?retryWrites=true&w=majority&appName=YogaMaster-ecommerce`;
